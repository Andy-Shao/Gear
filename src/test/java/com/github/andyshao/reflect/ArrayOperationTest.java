...
public class ArrayOperationTest {
    ...
    public void convertToMap() {
        Map<String , String> target =
            ArrayOperation.<String , String> convertToMap(Convert.OB_2_STR , Convert.OB_2_STR ,
    ...
    public void pack_unpack() {
        {
            Integer[] integers = ArrayOperation.pack_unpack(new int[] {
                1 , 2 , 3
            } , Integer[].class);
        ...
        {
            int[] is = ArrayOperation.pack_unpack(new Integer[] {
                1 , 2 , 3
            } , int[].class);
        ...
        {
            long[] ls = ArrayOperation.pack_unpack(new int[] {
                1
            } , long[].class);
    ...
    public void removeAllItem() {
        ...
        Assert.assertThat(ArrayOperation.removeAllItem(array , 3) , Matchers.is(new int[] {
            1 , 2 , 4 , 6 , 7 , 9
        }));
    }
    ...
    public void removeItem() {
        ...
        Assert.assertThat(ArrayOperation.removeItem(array , 3) , Matchers.is(new int[] {
            1 , 2 , 3 , 5 , 6 , 7 , 8 , 9
        }));
        Assert.assertThat(ArrayOperation.removeItem(array , 1 , 4) , Matchers.is(new int[] {
            1 , 5 , 6 , 7 , 8 , 9
        }));
    }
}

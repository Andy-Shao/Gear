...
public enum ResultCodeEnum implements ResultCode {
    ...
    SWITCHING_PROTOCOLE("101", "Switching Protocols"),
    ...
    PARTIAL_CONENT("206", "Partial Content"),
    MULTI_STATUS("207", "Multi-Status"),
    MULTPLE_CHOICES("208", "Multiple Choices"),
    MOVED_PREMANENTLY("301", "Moved Permanently"),
    FOUND("302", "Found"),
    ...
    INERNAL_SERVER_ERROR("500", "Internal Server Error"),
